 ...
 *
 * Los trazados son los de Material Icons (Apache 2.0), los mismos que pinta la
 * app Android, para que una sección se reconozca igual en los dos sitios. En
 * línea y no una fuente de iconos ni un paquete: son una docena, pesan menos
 * que la hoja de estilos de cualquier librería, y no piden nada nuevo a la CSP.
 *
 * Siempre decorativos (`aria-hidden`): el texto que va al lado es el que dice
 * qué es. Un icono suelto, sin texto, lleva su `aria-label` en el botón.
 */
